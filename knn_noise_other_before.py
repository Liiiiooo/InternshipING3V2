...
calibrated_knn = CalibratedClassifierCV(base_knn, method='isotonic', cv=3)
model = Pipeline([
...
plt.tight_layout()
plt.savefig('cv_conf_matrices_knn_other_before.png', dpi=300)
plt.close()
...
plt.savefig("Visualisations_noise_knn_other_before.png", dpi=300)
plt.close()
